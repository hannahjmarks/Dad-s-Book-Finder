...
namespace DadsBookFinderCustomClassLibrary
{
    public class BookFinderMainWindow : Window
    {
        #region Click events
        ...
        static BookFinderMainWindow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BookFinderMainWindow),
                new FrameworkPropertyMetadata(typeof(BookFinderMainWindow)));
        }
        ...
        public BookFinderMainWindow() : base()
        {
